...
#: JPEG quality pseudo-encodings, indexed by quality level 0 (low, -32)
#: through 9 (high, -23).  Offering one of these tells a server that
#: supports Tight that it may send lossy JPEG rectangles.
JPEG_QUALITY_ENCODINGS = [Encoding(-32 + quality) for quality in range(10)]
