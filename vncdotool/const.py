"""Constants for the RFB protocol, :rfc:`6143` and extensions."""
...
# JPEG quality pseudo-encodings, worst to best; the index into this list is
# the quality level a client asks for.
